...
const runTests = async () => {
  ...
  try {
    ...
    // Query slots for Friday, June 26th, 2026 (a future Friday)
    const checkSlotsRes = await apiRequest("GET", `/appointments/available-slots/${docUserId}?date=2026-06-26`, { Authorization: `Bearer ${patientToken}` });
    ...
    const checkSlots2 = await apiRequest("GET", `/appointments/available-slots/${docUserId}?date=2026-06-26`, { Authorization: `Bearer ${patientToken}` });
